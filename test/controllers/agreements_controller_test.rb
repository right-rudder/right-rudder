...
class AgreementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agreement" do
    assert_difference("Agreement.count") do
      post agreements_url, params: { agreement: { name: @agreement.name, sign_date: @agreement.sign_date } }
    end
  ...
  test "should update agreement" do
    patch agreement_url(@agreement), params: { agreement: { name: @agreement.name, sign_date: @agreement.sign_date } }
